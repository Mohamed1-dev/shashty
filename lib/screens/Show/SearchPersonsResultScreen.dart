...
class SearchPersonsResultScreen extends StatefulWidget {
  var dateTime;
  var subCatId;
  var searchWord;
  SearchPersonsResultScreen(this.dateTime, this.searchWord,
      {this.subCatId = 0});

  @protected
  @override
  createState() => SearchPersonsResultScreenState();
}

class SearchPersonsResultScreenState
    extends StateMVC<SearchPersonsResultScreen> {
  SearchPersonsResultScreenState() : super(SearchController()) {
  ...
  Future didChangeDependencies() async {
    ...
    if (isLoaded == false) {
      await _searchController.getAllPersonsResult(
