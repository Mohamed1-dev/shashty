...
class SearchMovieResultScreen extends StatefulWidget {
  DateTime dateTime;
  var subCatId;
  var searchWord;
  SearchMovieResultScreen(this.dateTime, this.searchWord, {this.subCatId = 0});

  @protected
  @override
  createState() => SearchMovieResultScreenState();
}

class SearchMovieResultScreenState extends StateMVC<SearchMovieResultScreen> {
  SearchMovieResultScreenState() : super(SearchController()) {
  ...
  Future didChangeDependencies() async {
    ...
    if (isLoaded == false) {
      await _searchController.getAllMovieResult(widget.searchWord,
