...
class SearchSeriesResultScreen extends StatefulWidget {
  var dateTime;
  var subCatId;
  var searchWord;
  SearchSeriesResultScreen(this.dateTime, this.searchWord, {this.subCatId = 0});

  @protected
  @override
  createState() => SearchSeriesResultScreenState();
}

class SearchSeriesResultScreenState extends StateMVC<SearchSeriesResultScreen> {
  SearchSeriesResultScreenState() : super(SearchController()) {
  ...
  Future didChangeDependencies() async {
    ...
    if (isLoaded == false) {
      await _searchController.getAllSeriesResult(widget.searchWord,
